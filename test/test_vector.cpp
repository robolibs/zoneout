...
TEST_CASE("Vector Global Properties - Save and Load") {
    ...
    std::vector<concord::Point> crop_area_points = {
        {10.0, 10.0, 0.0},
        {90.0, 10.0, 0.0},
        {90.0, 90.0, 0.0},
        {10.0, 90.0, 0.0},
    ...
    concord::Polygon crop_area(crop_area_points);
    ...
    // Add irrigation line
    concord::Line irrigation_line({20.0, 5.0, 0.0}, {80.0, 5.0, 0.0});
...
TEST_CASE("Vector Global Properties - Empty Properties") {
    ...
    concord::Polygon boundary(boundary_points);
    geoson::Vector vector(boundary, concord::Datum{0.001, 0.001, 1.0}, concord::Euler{0, 0, 0}, geoson::CRS::ENU);
